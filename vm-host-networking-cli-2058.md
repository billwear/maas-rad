...
![select_interface_for_bridge|690x391](upload://6yzWCYhSjNBx7FTqoGxwDL0tRgS.jpeg) 

4. Configure the bridge on a subnet MAAS controls.  You may use any IP mode for the bridge:

![save_bridge|690x393](upload://u92OzEVpPNt7fnbK2utQbSD8RHO.jpeg) 

When you're done, it should look something like this:

![configured_bridge|690x391](upload://dPg9sBzqe6xkW73vxTH65Puct0A.jpeg) 
