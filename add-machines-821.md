...
After the enlistment process, MAAS places the machine in the 'New' state.  'New' is a holding state for machines that need to be commissioned.
...
[note]
MAAS runs built-in commissioning scripts during the enlistment phase. When you commission a machine, any customised commissioning scripts you add will have access to data collected during enlistment. Follow the link above for more information about commissioning and commissioning scripts.
[/note]
...
<!-- cli
### CREATE CLI-BASED ADD MACHINE EXPLANATION HERE
 cli -->
...
<!-- cli
### ADD SUITABLE CLI EXPLANATION HERE
 cli -->
