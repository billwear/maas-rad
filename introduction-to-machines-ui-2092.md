...
![machine-list-general|690x416](upload://nxaIGoE6BvOD5RWejn5iEpxlUqu.jpeg) 
...
![machine-list-columns|690x105](upload://p2LxCphhF3JIIqBcPMwcbvCjmqw.jpeg) 
...
![machine-list-christmas-tree|663x500](upload://xcOJgaKuxbptpewxmaj7SBMa0jV.jpeg) 
...
![rollover-icons|690x222](upload://dS9S7DusQcZGKb866IWYkbx8AM4.jpeg) 
...
![machine-add-hardware-menu|690x235](upload://vFpXSa6sMBo9l8O3IKGkj49Q9DS.jpeg) 
...
![machine-take-action-menu-dropped|690x364](upload://q9VICqpENj2HaHRMy57JWtZmbnT.jpeg) 
...
![machine-details|690x439](upload://hCOcJR2x53Jcsrhm5Ctdr8TBLNi.jpeg)
...
The default view is 'Machine summary', presented as a series of cards detailing the CPU, memory, storage and tag characteristics of the machine, as well as an overview of its current status. When relevant, 'Edit' links take you directly to the settings pane for the configuration referenced within the card.  The machine menu bar within the web UI also includes links to logs, events, and configuration options:
 ![machine-event-output|690x370](upload://bmgoYq5YjilZ1gGPUYYaSv75cob.jpeg) 
...
![machine-summary-overview-card|690x119](upload://yI9SR8fnTXqEOxu1lxFVrwq52r4.jpeg) 
...
![cpu-test|690x215](upload://p9anCl9TASYAc7J7q5QMRRpcOcz.jpeg) 
...
![cpu-tests-log|690x185](upload://pNb5PsuTXrksD4BMu4edpA6opZ8.jpeg) 
...
![machine-network-tab|690x206](upload://d1pVrrlS7mRngrMJq1oKecH18SK.jpeg) 
...
![machine-network-tab-undeployed-machine|690x176](upload://sExc61efncuabDXv28IZQ6Nw0Mr.jpeg) 
...
![machine-storage-tab|690x431](upload://dteRcZ0XpmRtbaQLgMdXfogFiSZ.jpeg) 
...
![comm-logging-summary|690x279](upload://x6MUQpbR3Omk0Z3BgA5GUwh9Fj1.jpeg) 

Clicking on any of the "View log" links will take you to specific, detailed logs for that particular event or milestone:

![comm-logs-details|690x379](upload://cnolxacaeMYTwyDvpwMfadyRN4l.jpeg) 
...
![machine-menu-test-summary|690x189](upload://ms4IcNoH6xwG0FrOagkVVSI5By3.jpeg) 

You can view the summary report, or click on a "View log" link to get details on any particular tests:

![machine-test-tab-details|690x431](upload://1ZfexQjQes8DTezV5D3UM2Hy5Pi.jpeg) 
...
![machine-logs-tab|690x439](upload://tuAFSJdcWLMs9CJwoIm1Q58Q84n.jpeg) 
...
![machine-list-event-tab-log|690x305](upload://yRzJdN4bMOZ3CSXHudwlGrNzs2q.jpeg) 
...
The "Power configuration" supplies the parameters necessary for MAAS to access the machine to PXE-boot it. Note that this machine failed testing.  Editing the "Power configuration" section gives us a clue as to what might be wrong:
 ![power-config-failed-login|690x192](upload://8dzQcSMLbXPVwIxG5Acci0XM4Ol.jpeg) 

After entering the correct password and recycling things, the problem goes away:

![machine-config-no-error|690x388](upload://cWjfuiZXl7C7wbARdwA2qp6InEQ.jpeg) 
