...
![tftp-download-boot|618x500](upload://ksuUxjJns3mrR5NH55v9BjANhEx.jpeg) 

Next, initrd mounts a Squashfs image, ephemerally via HTTP, so that cloud-init can execute:

![squashfs|623x500](upload://izqdESy24j76IxFK4LLy6QLAFB1.jpeg) 

Finally, cloud-init runs enlistment and setup scripts:

![cloud-init|613x500](upload://yJrxKCvlham6IMqv36FlbU6l3EJ.jpeg) 
