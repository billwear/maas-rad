...
* [Print a machine list to the terminal using the CLI](/t/tips-tricks-and-traps/1506#heading--jq-machine-list)
...
<h2 id="heading--jq-machine-list">Printing a machine list to the terminal with jq</h2>
